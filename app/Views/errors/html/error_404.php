...
<head>
    ...
    <title>OAClients - Error 404 v3</title>
    <link rel="icon" type="image/png" href="/dashlite/images/favicon.png" />
                ...
                <div class="max-w-2xl p-6 text-center">
                    <div class="w-full max-w-md">
                        <img
                            ...
                            src="/lineone/images/illustrations/error-404.svg"
                            alt="image"
                        />
                        <img
                            class="w-full"
                            x-show="$store.global.isDarkModeEnabled"
                            src="/lineone/images/illustrations/error-404-dark.svg"
                            alt="image"
                        />
                    </div>
                    <p
