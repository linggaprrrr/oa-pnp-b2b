...
<div class="justify-between" style="display: flex;">
    <div class="mb-1">        
        <form action="/b2b/refunds/" method="GET" style="display: flex;">
        <?php csrf_field() ?>
            <div class="mr-4">
    ...
    <div class="card px-4 pb-2 sm:px-5">
        <div class="my-3 flex h-8 items-center justify-between flex">
            ...
            <div>
                <?php if (!is_null($start)) : ?>
                    <?php if (!is_null($end)) : ?>
                        <a href="/b2b/export-refunds/<?= $start ?>&<?= $end ?>" class="btn bg-error font-medium text-white hover:bg-error-focus focus:bg-error-focus active:bg-error-focus/90"><em class="fas fa-file-pdf mr-1"></em> Export</a>           
                    <?php else : ?>
                        <a href="/b2b/export-refunds/<?= $start ?>" class="btn bg-error font-medium text-white hover:bg-error-focus focus:bg-error-focus active:bg-error-focus/90"><em class="fas fa-file-pdf mr-1"></em> Export</a>           
                    <?php endif ?>
                <?php else : ?>
                    <a href="/b2b/export-refunds" class="btn bg-error font-medium text-white hover:bg-error-focus focus:bg-error-focus active:bg-error-focus/90"><em class="fas fa-file-pdf mr-1"></em> Export</a>             
                <?php endif ?>
