    ...
    <div id="wrapper" class="horizontal">
        ...
        <header class="border-none is-transparent backdrop-filter backdrop-blur-2xl bg-opacity-80"
            ...
            <div class="header_inner">
                ...
                <div class="right-side">
                    ...
                    <a href="/b2b/login" class="btn_buy"> Login </a>
        ...
        <div class="bg-white pt-56 pb-28 -mt-20">
            ...
            <div class="max-w-md mx-auto rounded-xl">
                <form class="w-full" action="/b2b/log-in" method="post" autocomplete="off">
            
                    <div class="mb-12 text-center">
                        <h1 class="lg:text-4xl text-2xl font-semibold mb-4"> Sign In to OA (B2B)</h1>
