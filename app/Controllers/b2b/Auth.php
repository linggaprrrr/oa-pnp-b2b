...
class Auth extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->googleClient->setRedirectUri("https://quickprep.ai/b2b/login/process");
    ...
    public function signupProcess() {
        ...
        try {
            ...
            return redirect()->to(base_url('/b2b/login'))->with('message', 'Please sign in with your registered email');
        } catch (\Throwable $th) {
            return redirect()->to(base_url('/b2b/sign-up'))->with('error', 'Email has been used');
        }
    ...
    public function forgotPasswordProcess() {
        ...
        return redirect()->to(base_url('/b2b/login'))->with('message', 'Please check your email');
    }
    ...
    public function resetPasswordProcess() {
        ...
        $this->userModel->set('password', $password)
            ->where('oauth_uid', $uid)
            ->update();
        return redirect()->to(base_url('/b2b/login'))->with('message', 'Please sign in with your new password');
    }
